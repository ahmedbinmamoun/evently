      ...
      appBar: AppBar(
        title: Text('Event Details',style: AppStyle.medium20Primary),
         ...
         actions: [
          InkWell(
            onTap: () async{
              final updateEvent = await Navigator.pushNamed(
                context,
                 AppRoutes.editEvent,
                 arguments: event
                 ) as Event?;
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Image.asset(AppAssets.calenderIcon,color: AppColors.whiteColor,),
                      ),
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(DateFormat('dd/MM/yyyy').format(event.eventDateTime),style: AppStyle.medium16Primary,),
