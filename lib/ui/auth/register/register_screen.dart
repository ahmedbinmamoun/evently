            ...
            child: Column(
              ...
              children: [
                ...
                Form(
                  ...
                  validator: (text) {
                    if(text == null || text.isEmpty){
                      return AppLocalizations.of(context)!.plaese_enter_name;
                    }
                ...
                CustomTextFormFeild(
                  ...
                  validator: (text) {
                    if(text == null || text.isEmpty){
                      return AppLocalizations.of(context)!.plaese_enter_re_password;
                    }
                    if(passwordController.text != text){
                      return AppLocalizations.of(context)!.re_password_doesnt_match;  
                    }
                    return null;
                  },
                  prefixIcon: Image.asset(AppAssets.passwordIcon,color: Theme.of(context).hintColor),
